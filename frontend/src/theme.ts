...
export const theme = createTheme({
  palette: {
    mode: "light",
    primary: { main: "#902e43", contrastText: "#ffffff" }, // brand red (buttons, links, citizen app-bar)
    secondary: { main: "#a45311", contrastText: "#ffffff" }, // deep maroon (dark sections, admin app-bar)
